...
matrix_exp(t) = e^{Qt},
$$
where $generator$ is the generator matrix of the Markov process, which contains the
...
$$
which for $pop_size=100$ is already over 5000 states. Thus, this whole approach
