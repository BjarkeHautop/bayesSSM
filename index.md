...
N particles to approximate the intractable marginal likelihood and then
uses this approximation in the acceptance probability. The
...
![](reference/figures/SSM_equation.png)
