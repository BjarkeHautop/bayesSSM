...
the marginal likelihood ![](man/figures/marginal_posterior.png) is intractable,
and traditional MCMC methods cannot be used.
...
the intractable marginal likelihood $p(y_{1:T} \mid \theta)$ and then uses this
