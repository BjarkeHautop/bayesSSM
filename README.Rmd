...
The Particle Markov Chain Monte Carlo (PMCMC) methods, such as the Particle
...
marginal likelihood and allow for efficient sampling from the posterior
density of the latent states and parameters.
