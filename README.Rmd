...
scratch anyway. Everything is written in R, so performance is not the best, but
it is easy to use. 
...
The implementation automatically tunes the number of particles and the proposal distribution for the parameters. 
