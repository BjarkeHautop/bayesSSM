...
[![CRAN monthly
downloads](https://cranlogs.r-pkg.org/badges/bayesSSM)](https://cran.r-project.org/package=bayesSSM)
[![CRAN total
...
$\theta$ and the latent states $x_{1:T}$ given observations $y_{1:T}$ is
